...
import { Mail, CheckCircle, ArrowRight, Phone, MessageSquare, ChevronDown } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-light bg-gradient-to-r from-header-from to-header-to bg-clip-text text-transparent mb-6">
              Thank You. Your Healing Journey Just Began.<br />Can you feel the shift?
            </h2>

            <div className="text-xl text-foreground/80 mb-8 max-w-2xl mx-auto space-y-4">
              <p>
              ...
              <div className="font-medium text-foreground">
                <p className="mb-2">For now, pause and take this in:</p>
                <div className="space-y-2">
                  <motion.p
                    ...
                    className="text-2xl bg-gradient-to-r from-header-from to-header-to bg-clip-text text-transparent"
                  >
                    You are not broken.
                  </motion.p>
                  <motion.p
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3 sm:py-4 pr-12 bg-form-bg backdrop-blur-sm border-form-border text-form-text placeholder-form-placeholder rounded-lg h-auto text-base appearance-none"
                  >
                  ...
                  <ChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-form-placeholder pointer-events-none" />
                </div>
              </div>
